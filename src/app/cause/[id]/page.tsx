...
export default function CausePage() {
  ...
  return (
    <>
        ...
        <div className="grid md:grid-cols-[2.5fr,1.5fr] gap-12">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-700">
              ...
              simple story. Conflict and displacement, disease outbreaks,
              natural disasters and other disruptions have heightened the risks
              of kids dropping out of school permanently. Climate crises such as
              severe drought in the Horn of Africa have pushed millions of
              families deeper into poverty, increasing economic pressures that
              lead children to go to work instead of school. <br />
              <br />
              ...
              health care, immunizations and their one nutritious meal of the
              day. Girls who are not in school are often forced into early
              marriage.
            </p>
          </div>
      ...
      {/* Move the floating buttons outside the main container */}
      <div className="fixed inset-x-0 bottom-0 md:hidden bg-white border-t border-gray-200 p-4 flex gap-3 z-50">
